...
const Head:React.FC = () => {
  ...
  <div className={styles.flexcontainer}>
      ...
      <div className={styles.person} >
        <div style={{fontWeight:'bold'}}>Dhoni</div>
        <div className={styles.itemflex}>6 June 2021, 12:10pm</div>
      </div>
      </div>
      <div className={styles.rightbox}>
        ...
        <div className={styles.def}>
           <div style={{fontWeight:'bold'}}>2100</div>
           <div className={styles.flexitem}>Gross Coins</div>
          </div>   
