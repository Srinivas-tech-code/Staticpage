...
<Image className='zero' alt='ucoin'  width={18} height={18} src={'/ucoin.png'}/>
    ...
    <Image width={40} height={40}  alt={"Dhoni"} src={"/Virat.jpg"}/>
    </div>
    ...
    <div className={styles.seven}> 
        ...
        <div style={{position:'absolute',marginTop:'28%'}} >@Virat_kohli...Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo, velit.</div>
